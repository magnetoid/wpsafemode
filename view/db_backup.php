	...
	<div class="large-4 columns text-left widget" >
		<div class="widget-title dashboard-panel ">
			...
			<form method='post' id='' action=''>
				<ul>
					<li><input type='radio' name='backup_database_type' class="backup-type" value='full' checked> Backup Full Database</li>
					<li><input type='radio' name='backup_database_type' class="backup-type" value='partial'> Backup Partially</li>
				</ul>
				<div class="tables-list">
					<?php foreach($data['tables'] as $table): ?>
					<li><input type='checkbox' name='backup_tables_list[]' value='<?php echo $table; ?>' /> <?php echo $table; ?></li>
					<?php endforeach; ?>					
					<li><input type='checkbox' name='backup_tables_type[]' value='sql' checked/> Export Tables in SQL format</li>
					<li><input type='checkbox' name='backup_tables_type[]' value='csv' /> Export Tables in CSV format</li>	
				</div>
