	...
	<div class="row" data-equalizer>
		<div class="large-6 columns text-left widget" data-equalizer-watch>
			<div class="widget-title dashboard-panel " data-equalizer-watch>
				...
				<div>Due to different server time out limits, search will be limited up to 1000 records per search </div>
				<div class="row">
				...
				<div class="row">
					<div class="columns large-12">
						...
						<input type="text" name="replace_term" id="replace_term" disabled="disabled" placeholder="Replacement is currently disabled"/>   		
					</div>
				</div>
				<div class="row">
					<div class="columns large-12">     	
					  	...
					  	<div id="advanced-search" class="advanced-panel">
							<div class="row">
								<div class="columns large-12">   
									...
									<label for="search-criteria-term-1"><input type="radio" name="search_criteria_term" id="search-criteria-term-1" value="contains" checked/>That contain term</label>  	
									<label for="search-criteria-term-2"><input type="radio" name="search_criteria_term" id="search-criteria-term-2" value="exact"/>That have exact term </label>  	
									<label for="search-criteria-term-3"><input type="radio" name="search_criteria_term" id="search-criteria-term-3" value="any"/>That have any of the terms</label>  	
								</div>
							</div> 
							<div class="row">
								<div class="columns large-12"> 
