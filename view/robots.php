		...
		<div class="widget-title dashboard-panel ">
		    ...
		    <div class="row">
				...
				<form method='post' id='save_robots' action=''>	
					...
					?>
				<input type='submit' class='btn btn-blue' name="save_robots" id="save_robots" value="Save robots.txt"> 
				<?php endif;?>
				</form>
			</div>
	...
	<div class="large-4 columns text-left edit_htaccess_div widget" data-equalizer-watch>
		<div class="dashboard-panel">
			<?php if(!isset($data['robots'])) : ?>
				...
				<textarea placeholder=".htaccess content" rows="12" cols="5" name="htaccess_content" id="htaccess_content" disabled="disabled"><?php echo $robots_file; ?></textarea></br>
			<?php endif;?>
		</div>
	</div>	
</div>