...
class PluginService
{
    ...
    /**
     * Revert plugins to initial state
     * 
     * @return bool
     */
    public function revertPlugins(): bool
    {
        $result = $this->model->save_revert_plugins();
        if ($result) {
            $this->cache->delete('active_plugins');
        }
        return $result;
     ...
     * @return bool
     */
    public function backupActivePluginsList(): bool
    {
        return $this->model->backup_active_plugins_list();
    }
}
